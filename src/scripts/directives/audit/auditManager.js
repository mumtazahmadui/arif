(function(){
    ...
    angular
        ...
        .directive('auditManagerTooltipCompile', auditManagerTooltipCompile)
        .directive('auditManagerTooltipCompilePopup',auditManagerTooltipCompilePopup);


    // @ngInject
    function auditManagerTooltipCompile($tooltip) {
        return $tooltip( 'auditManagerTooltipCompile', 'tooltip', 'mouseenter' );
    }

    function auditManagerTooltipCompilePopup(auditLegalManger){
        return {
            restrict: 'EA',
            replace: true,
            scope: {
