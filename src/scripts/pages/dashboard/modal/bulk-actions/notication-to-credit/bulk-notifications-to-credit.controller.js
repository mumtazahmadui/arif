...
(function(){
	...
	angular.module('app.controllers')
	    .controller('creditModalController', creditModalController);

	function creditModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,CreditService,$window) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('credit');
		...
		$scope.preveiwEmail = function(rows) {
			...
			CreditService.previewEmail('Credit',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
           ...
           CreditService.notify('Credit',options)
            .then(function(resp) {
