...
(function(){
	...
	function onboardingModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,OnboardingService,$window) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('onboarding');
		...
		$scope.preveiwEmail = function(rows) {
			...
			OnboardingService.previewEmail('Onboarding',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
            ...
            OnboardingService.notify('Onboarding',options)
            .then(function(resp) {
