...
(function(){
	...
	angular.module('app.controllers')
	    .controller('kycModalController', kycModalController);

	function kycModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,kycService,$window) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('kyc');
		...
		$scope.preveiwEmail = function(rows) {
			...
			kycService.previewEmail('KYC',options).then(function(resp) {
