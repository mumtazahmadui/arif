...
(function(){
	...
	function managerModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,managerService,$window) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('manager');
		...
		$scope.preveiwEmail = function(rows) {
			...
			managerService.previewEmail('Manager',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
           ...
           managerService.notify('Manager',options)
            .then(function(resp) {
