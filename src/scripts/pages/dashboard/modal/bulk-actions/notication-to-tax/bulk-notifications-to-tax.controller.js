...
(function(){
	...
	function taxModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,taxService,$window) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('tax');
		...
		$scope.preveiwEmail = function(rows) {
			...
			taxService.previewEmail('Tax',options).then(function(resp) {
