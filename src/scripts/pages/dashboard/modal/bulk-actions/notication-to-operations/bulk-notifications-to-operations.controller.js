...
(function(){
	...
	angular.module('app.controllers')
	    .controller('operationsModalController', operationsModalController);

	function operationsModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,operationsService,$window) {
		...
		$scope.preveiwEmail = function(rows) {
			...
			operationsService.previewEmail('Operations',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
           ...
           operationsService.notify('Operations',options)
            .then(function(resp) {
