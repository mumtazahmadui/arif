...
(function(){
	...
	angular.module('app.controllers')
	    .controller('bsmanagerModalController', bsManagerModalController);

	function bsManagerModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,bsManagerService,$window,myStatusService) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('desk2');
		...
		$scope.preveiwEmail = function(rows) {
			...
			bsManagerService.previewEmail('bsdesk2',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
           ...
           bsManagerService.notify('bsdesk2',options)
            .then(function(resp) {
