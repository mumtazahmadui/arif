...
(function(){
	...
	angular.module('app.controllers')
	    .controller('bslegalModalController', bslegalModalController);

	function bslegalModalController($scope, $modalInstance, data,rfaGridSelection,CredentialsService,bslegalService,$window,myStatusService) {
        ...
        function init() {
            return new Promise(function(reslove,reject) {
                var getUser = CredentialsService.getUserNotification('desk1');
		...
		$scope.preveiwEmail = function(rows) {
			...
			bslegalService.previewEmail('bsdesk1',options).then(function(resp) {
		...
		$scope.notification = function(rows) {
           ...
           bslegalService.notify('bsdesk1',options)
            .then(function(resp) {
